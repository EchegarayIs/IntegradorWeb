...
try {
    ...
    if ($passwor !== $confirmar) {
        echo "<script>alert('Las contraseñas no coinciden.'); window.location.href='../vista/admin.php';</script>";
        exit;
    }
    ...
    if ($resultado) {
        ...
        echo "<script>alert('Editado con exito.'); window.location.href='../vista/admin.php';</script>";
    } else {
        echo "<script>alert('Error al actualizar el usuario.'); window.location.href='../vista/admin.php';</script>";
    }

} catch (Exception $e) {
    echo "<script>alert('Error: " . $e->getMessage() . "'); window.location.href='../vista/admin.php';</script>";
}
?>